...
const standard_passes = [
	pass_function_definition, pass_variable_definition,
	pass_return_statement,
	pass_chunk, pass_function_call, pass_primitive,
	pass_final,
];

export {
	pass_chunk, pass_final, pass_function_definition, pass_primitive, 
